    ...
    <div id="page-wrap">
        ...
        <form action="#" method="post" @submit.prevent="formReset">
            <fieldset id="step_1">
                ...
                <br>
                <div id="attendee_container" v-show-slide="numAttenders > 0">
            ...
            <fieldset id="step_2" :disabled="!steps['step-1'].valid()" :class="{'step-disabled': !steps['step-1'].valid()}">
                ...
                <div id="company_name_wrap" v-show-slide="companyYes">
                ...
                <div id="special_accommodations_wrap" v-show-slide="accomodationYes">
